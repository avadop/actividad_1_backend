...
ALTER TABLE `series` ADD FOREIGN KEY (`director`) REFERENCES `directors`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; 
ALTER TABLE `series` ADD FOREIGN KEY (`audio_language`) REFERENCES `languages`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `series` ADD FOREIGN KEY (`subtitles_language`) REFERENCES `languages`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; 
